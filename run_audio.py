#export OPENAI_API_KEY="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"
...
from record import record_audio, read_audio, play_audio

openai_key="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"
assemblyai_key= "675a827b2f5648da893226c87cc6a3e3"
...
def run(document):
    '''
    def: this function is responsible to create a chatBot using GPT-3.5-turbo and takes query as a real time audio input and outputs the text response by playing it on the machine. 
        args:
          document: .pdf document
    '''
    ...
    while query != 'resolved':
        ...
        record_audio(str(count) + '.wav')
        print("audio recording stopped")
        query = read_audio(str(count) + '.wav', assemblyai_key)
        count = count + 1 
        if query != exit:
